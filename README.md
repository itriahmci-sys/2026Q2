...
<section id="about">
  <div class="container">
    ...
    <div class="about-text">
      <p>「健康樂活與智慧醫療照護聯盟」在經濟部技術司的支持與指導下，2026年第二季論壇以「跨域整合科技與動態需求的心理健康照護新典範」為主題，匯聚國內各領域專家，共同分享數位療法於心理健康照護的實務應用，並深入探討相關技術發展及倫理議題。</p>
  ...
  <div class="container">
    ...
    <div class="agenda-list">
      ...
      <div class="agenda-item">
        ...
        <div class="agenda-content">
          <div class="agenda-title">以智慧型偵測裝置輔助診斷及評估 ADHD</div>
